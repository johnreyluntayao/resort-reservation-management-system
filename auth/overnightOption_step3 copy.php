...
<input type="number" id="children" name="children" value="" style="text-align: center;"><br>
        ...
        <label for="total-package-rate" style="display: none">Total Package Rate:</label>
        <input type="number" id="total-package-rate" name="total_package_rate" style="display: none; text-align: center;" readonly>
...
function calculateTotalPrice() {
    ...
    totalPackageRateInput.value = `${totalPackageRate}`;
}
...
function calculateTotalPackageRate() {
    ...
    totalPackageRateInput.value = (totalPrice + extraCharge) * (parseInt(numberOfNightsInput.value) || 1);
}
